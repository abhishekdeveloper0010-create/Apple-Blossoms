      ...
      <div className="w-full">
        <div className="mb-8 flex items-center justify-between">
          ...
          <button
            ...
            className="rounded-xl bg-cyan-700 px-5 py-3 font-semibold text-white hover:bg-cyan-800"
          >
            + Add Coupon
          </button>
        </div>
          ...
          <div className="mb-8 rounded-2xl bg-white p-6 shadow-sm">
            ...
            >
              ...
              <div className="flex gap-3 col-span-full">
                <button
                  type="submit"
                  className="rounded-lg bg-cyan-700 px-6 py-2 font-semibold text-white hover:bg-cyan-800"
                >
              ...
              <tbody className="divide-y divide-slate-100">
                {coupons.map((coupon) => (
                  <tr key={coupon.id} className="hover:bg-slate-50">
                    ...
                    <td className="px-4 py-3">
                      Rs{coupon.min_order_amount || 0}
                    </td>
                    <td className="px-4 py-3">
                      {coupon.used_count || 0} / {coupon.usage_limit || "inf"}
                    </td>
                    ...
                    <td className="px-4 py-3">
                      <button
                        ...
                        className={`rounded-full px-3 py-1 text-xs font-semibold ${coupon.is_active ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}
                      >
