        ...
        {showForm && (
          <div className="mb-8 rounded-2xl bg-white p-6 shadow-sm">
            ...
            <form onSubmit={handleSubmit} className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4">
              ...
              <div className="col-span-full"><label className="mb-1 block text-sm font-medium text-slate-700">Message</label><textarea value={form.message} onChange={(e) => setForm({ ...form, message: e.target.value })} className="w-full rounded-lg border border-slate-300 px-4 py-2" rows="3" placeholder="Happy Birthday!" /></div>
